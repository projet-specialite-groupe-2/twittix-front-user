  ...
  <v-container class="py-0 px-3">
    ...
    >
      <v-row>
        ...
        <v-col cols="11">
          <v-row class="ml-2">
            <a v-on:click.stop="redirectToProfile" class="font-weight-black mx-1 profile-name">{{
              props.username
            }}</a>
      ...
      <v-row no-gutters class="mt-5 w-100 justify-space-evenly">
        ...
        <v-col cols="auto" class="d-flex justify-center">
          <v-btn
            variant="text"
            :class="props.idReTwit ? 'custom-btn-retwit' : 'custom-btn custom-btn-retwit-hover'"
            v-on:click.stop="reTwit"
          >
        ...
        <v-col cols="auto" class="d-flex justify-center">
          <v-btn
            variant="text"
            :class="props.isLiked ? 'custom-btn-like' : 'custom-btn custom-btn-like-hover'"
            v-on:click.stop="likeTwit"
          >
